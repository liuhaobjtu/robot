...
int main(int argc, char **argv) {
    ...
    pcl::io::loadPCDFile("../../../data/cloud_002.pcd", *cloud_src_o);
    PointCloud::Ptr cloud_tgt_o(new PointCloud);//目标点云
    pcl::io::loadPCDFile("../../../data/cloud_003.pcd", *cloud_tgt_o);
...
//    voxel_grid_2.setLeafSize(5, 5, 5);
...
//    scia.setTargetFeatures(fpfhs_tgt);
    ...
    cout << "error in aixs_x: " << error_x << "  error in aixs_y: " << error_y << "  error in aixs_z: " << error_z
         << endl;
